    ...
    <table>
        ...
        <c:forEach var="planeta" items="${planetas}">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/planetaForm/${planeta.idplaneta}">Modificar</a></td>
                <td>
                    <form action="${pageContext.request.contextPath}/deletePlaneta" method="post">
